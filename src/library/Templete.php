...
class Template
{
     ...
     * @return string|false
     */
    private function parseTemplateFile($template, $jumpDefaultTemplate = 1)
    {
        ...
        if (is_file($template)) {
            ...
            if($jumpDefaultTemplate)
            {
                ...
                return $this->parseTemplateFile($oriTemplate, 0);
            }
            throw new TemplateNotFoundException('template not exists:' . $oriTemplate, $oriTemplate);
        }
    }
